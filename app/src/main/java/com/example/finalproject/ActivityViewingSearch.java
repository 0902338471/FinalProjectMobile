...
public class ActivityViewingSearch extends AppCompatActivity {
    ...
    private void initiateViewComponent() {
        ...
        progressDialog = new ProgressDialog(ActivityViewingSearch.this);
    }
            ...
            storageReference2nd.putFile(FilePathUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(ActivityViewingSearch.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
